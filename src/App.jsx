...
import { handleEmailLogin, handleGoogleLogin } from "./config";
import "./App.css";
const App = () => {
  ...
  return (
    <div
      className=" min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-500
    ...
    >
      ...
      >
        ...
        <form
          onSubmit={(e) => handleEmailLogin(e,emailRef, passRef, setError)}
          className=" space-y-6"
        >
          <div>
            <label
          ...
          <button
            type="submit"
            className=" w-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-2 rounded-lg hover:bg-gradient-to-l
        ...
        <button
          ...
          className=" mt-6 w-full flex items-center justify-center bg-gray-700 border border-gray-600 py-2
